  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          <div className="flex items-center space-x-2">
            <img src="/images/logo/logo.jpg" alt="Soptify" className="h-8 w-8 rounded-full" />
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-green-500 to-green-700 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg md:text-xl font-bold">Millions of Songs*</h3>
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg md:text-xl font-bold">Countdown to Disappointment</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg md:text-xl font-bold">Secure Login</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
